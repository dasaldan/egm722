...
NI_Wards = NI_Wards.to_crs(epsg=32629)

for col_counties in counties.columns:
    print(col_counties)

for col_NI_Wards in NI_Wards.columns:
    print(col_NI_Wards)
# load the necessary data here and transform to a UTM projection

# your analysis goes here...
join = gpd.sjoin(counties, NI_Wards, how='inner', lsuffix='left', rsuffix='right')
print(join)
# ---------------------------------------------------------------------------------------------------------------------
